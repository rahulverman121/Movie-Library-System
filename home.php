...
<div class="rightt"><img src="avatar1.jpg" width="50rem" id="profile"><img src="logout.png" width="33rem" height="33rem" id="logout"></div>
</header>
<script>
var movie;
...
<section id="movie">
<section id="poster">
<span id="image" style="visibility:hidden"></span>
...
<section id="cardlist">
<?php
$con = mysqli_connect('localhost:3302','root','','wootube');
$id = $_SESSION["id"] ;
